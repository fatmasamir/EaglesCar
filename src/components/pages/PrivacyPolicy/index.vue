        ...
        <div class="col-lg-12">
          ...
          <ul>
            ...
            <li>
              ...
              "We", "Us" or "Our" in this Agreement) refers to eagles cars,
              cairo-egypt.
            </li>
            <li>
            ...
            <li>
              <strong>Website </strong>refers to eagles cars, accessible from
              <router-link to="https://eagles-car.com/"
                >eagles-cars.com</router-link
              >
            </li>
            <li>
          ...
          <p>
            ...
            available through <br />the Website and to enable You to use some of
            its features. They help to authenticate<br />
            users and prevent fraudulent use of user accounts. Without these
            Cookies, the <br />services that You have asked for cannot be
          ...
          <p>
            ...
            Type: Persistent Cookies Administered by: Us <br />Purpose: These
          ...
          <h6 class="mt-5">By phone number: 00201018041887</h6>
        </div>
      </div>
    </div>
  </div>
