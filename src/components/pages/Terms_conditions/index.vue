...
<template>
  ...
  <div class="Terms_conditions">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h5>Welcome to Eagles Car!</h5>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of Eagles Car's Website, located at https://eagles-car.com/.
          </p>
          <p>
            By accessing this website, we assume you accept these terms and
            conditions. Do not continue to use Eagles Car if you do not agree to
            take all the terms and conditions stated on this page.
          </p>
          <p class="mt-5">
          ...
          <h6>Cookies</h6>
          <p>
            We employ the use of cookies. By accessing Eagles Car, you agreed to
            use cookies in agreement with the Eagles Car's Privacy Policy.
          </p>
          <p>
          ...
          <h6>License</h6>
          <p>
            Unless otherwise stated, Eagles Car and/or its licensors own the
            intellectual property rights for all material on Eagles Car. All
            intellectual property rights are reserved. You may access this from
            Eagles Car for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Republish material from Eagles Car</li>
            <li>Sell, rent or sub-license material from Eagles Car</li>
            <li>Reproduce, duplicate, or copy material from Eagles Car</li>
            <li>Redistribute content from Eagles Car</li>
          </ul>
          <p>
            Parts of this website offer an opportunity for users to post and
            exchange opinions and information in certain areas of the website.
            Eagles Car does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of Eagles Car,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws, Eagles Car
          ...
          <p>
            Eagles Car reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant Eagles Car a non-exclusive license to use,
          ...
          <ul>
            ...
            <li>
              online directory distributors; internet portals; accounting, law
              and
            </li>
            <li>
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Eagles Car;
          ...
          <p>
            ...
            sending an e-mail to Eagles Car. Please include your name, your
          ...
          <p>
            No use of Eagles Car's logo or other artwork will be allowed for
